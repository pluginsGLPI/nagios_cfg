...
if ($_SESSION["glpiactiveprofile"]["interface"] == "central") {
   Html::header(PluginNagiosHostGroup::getTypeName(2),$_SERVER['PHP_SELF'],"plugins","PluginNagiosRole","");
} else {
   Html::helpHeader("Role", $_SERVER['PHP_SELF']);
}
//checkTypeRight('PluginExampleExample',"r");

Search::show('PluginNagiosRole');
Html::footer();
?>
