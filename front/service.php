...
if ($_SESSION["glpiactiveprofile"]["interface"] == "central") {
   Html::header(PluginNagiosService::getTypeName(2),$_SERVER['PHP_SELF'],"plugins","PluginNagiosService","");
} else {
   Html::helpHeader("ServiceTemplate", $_SERVER['PHP_SELF']);
}
//checkTypeRight('PluginExampleExample',"r");


Search::show('PluginNagiosService');
Html::footer();
?>
