...
if ($_SESSION["glpiactiveprofile"]["interface"] == "central") {
   Html::header(PluginNagiosSatellite::getTypeName(2),$_SERVER['PHP_SELF'],"plugins","PluginNagiosSatellite","");
} else {
   Html::helpHeader("Command", $_SERVER['PHP_SELF']);
}
//checkTypeRight('PluginExampleExample',"r");


Search::show('PluginNagiosSatellite');
Html::footer();
?>
