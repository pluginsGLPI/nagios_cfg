...
class PluginNagiosLinkInjection extends PluginNagiosLink
   ...
   function data_populate() {
	...
	$INJECTABLE_TYPES['PluginNagiosLinkInjection']="datainjection";
   }
   ...
   **/
   function getOptions($primary_type='') {
      ...
      $tab[111]['table']        = 'glpi_plugin_nagios_objects';
